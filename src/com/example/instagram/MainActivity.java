...
public class MainActivity extends Activity {
	...
	private final String ACCESS_TOKEN = "256954527.75d4a3c.66aca73947e248b1af9c910e6846a418";
	int number = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		request = new RequestImagesTask(
				"https://api.instagram.com/v1/tags/selfie/media/recent?access_token=" + ACCESS_TOKEN ,
				this);
		request.execute();
